...
$status = 'A';
        ...
        $data_accept = ['accept_date'=>$date,'accept_time'=>$time,'inv'=>$details[0]['itemid'],
        'prn'=>$details[0]['prn'],'visitno'=>$vsn,'comment'=>$comment,'pat_cat'=>$cat,
        'saved_by'=>$by,'bcode'=>$bcode,'status'=>$status,'pat_type_id'=>$details[0]['ptypeid']];

    $insert_obj->create('rad_waiting_list',$data_accept);
