            	...
            	<div class="table-responsive">
                    ...
                    <table id="portrait_searchdata" class="table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th style="background-color:#005384; color:#fff">Services name</th>
                                <th style="background-color:#005384; color:#fff">Department</th>
                                <th style="background-color:#005384; color:#fff">Unit Cost</th>
                                <th style="background-color:#005384; color:#fff">Unit Sales</th>
                                <th style="background-color:#005384; color:#fff">Status</th>
                            </tr>
                        </thead>
                        <tfoot>
                        </tfoot>
