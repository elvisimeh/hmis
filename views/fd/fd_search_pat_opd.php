...
<button class="btn btn-primary" id="opd_services" style="padding:2% 2% 2% 2%">Continue</button>
</div>
...
$('.searchable').select2({
 ...
 $('#opd_services').click(function(){
   ...
   if($('#pat_name').text().trim() != ''){
      $('#pat_name').text('');
    $('#load_search_result').load('fd/fd_patient_search_result_opd?prn='+prn+'&cat='+cat);
 }
 else{
