...
<div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-6">
    <label for="" class="control-label mb-1">Vaccine Name</label>
    ...
    <select name="vaccine" id="vaccine" class="searchable_vaccine form-control">
        ...
        <input type="hidden" name="" id="prn" value="<?php echo $prn ?>">
...
$('.searchable_vaccine').select2({
 ...
 $('#vaccine').change(function(){  
        // for(i=0; i<services.length-1; i++){
         ...
         if(services != null && services.includes($('#vaccine').val())){
             alert('Service already ordered!');
         }
         else{
    services.push($('#vaccine').val());
