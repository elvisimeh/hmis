...
$visits = $obj->selects('patient_visit_tbl',"WHERE vdate ='".date('Y-m-d')."'");
//var_dump($vaccines);
//var_dump($titles); 
?>
...
<?php $current_right='Callback Patient'; if($tools->check_rights($rights,$current_right)){ ?>
...
<strong style="color:white;font-size:1.4em">Callback Patients</strong>
</div>
