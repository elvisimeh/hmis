...
<div class="row">
    ...
    <option value="Select Sub Account" selected disabled>Select Sub Account</option>
		...
		<tr>
			...
			Account Class</font></b></td>
			<input type="hidden" name ="id" id ="id" value="<?php echo $id;?>" size="50">
			<td>
			<input type="text" name ="aclass" id ="aclass" class="form-control form-txt-primary" size="50"></td>
		</tr>
		<tr>
			<td width="141">&nbsp;</td>
			<td><div class="row m-t-30">
<div class="col-md-12">
<button type="button" id ="submit" name ="submit" class="btn btn-primary btn-md waves-effect text-center m-b-10" onclick="saveAccountClass()">Save 
