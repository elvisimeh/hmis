                                    ...
                                    <div align="center">
										<table border="0" width="85%" cellpadding="3">
											<tr>
												...
												<td>
												<input type="text" name ="cat" id ="cat" class="form-control form-txt-primary" size="50"></td>
											</tr>
											<tr>
												<td width="187">&nbsp;</td>
												<td><div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="button" id ="submit" name ="submit" class="btn btn-primary btn-md waves-effect text-center m-b-10" onclick="saveICat()">
										Save</button>
                                    </div>
                                </div></td>
											</tr>
