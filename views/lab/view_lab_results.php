...
<strong style="color:white;font-size:1.4em">View Lab Results</strong>
</div>
...
<div class="col-md-6">
        <select name="" id="sel_pat" class="searchable_inv"></select>
    </div>
...
$('.searchable_inv').select2({
 ...
 $('#sel_pat').change(function(){
    var prn = $('#sel_pat').val();
    lab_result_per_prn(prn);
 });

 function lab_result_per_prn(prn){
    $('#workspace').load('lab/show_all_result?prn='+prn);
 }
