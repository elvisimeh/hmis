...
<div class="row">
    ...
    <option value="Select Account Class" selected disabled>Select Account Class</option>
		...
		<tr>
			...
			Account Ledger</font></b></td>
			<input type="hidden" name ="id" id ="id" value="<?php echo $id;?>" size="50">
			<td>
			<input type="text" name ="ledger" id ="ledger" class="form-control form-txt-primary" size="50"></td>
		</tr>
		<tr>
			<td width="195">&nbsp;</td>
			<td><div class="row m-t-30">
<div class="col-md-12">
<button type="button" id ="submit" name ="submit" class="btn btn-primary btn-md waves-effect text-center m-b-10" onclick="saveAccountLedger()">Save 
