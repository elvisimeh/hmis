...
<div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="signup-card card-block auth-body mr-auto ml-auto">
						...
						<font color="#FF0000">Add Item Subcategory</font></h3>
                                    </div>
                                </div>
                                <hr/>
                                <div>
    ...
    <?php  } ?>
                                    ...
                                    <div class="col-md-12">
                                        <button type="button" id ="submit" name ="submit" class="btn btn-primary btn-md waves-effect text-center m-b-10" onclick="saveItemSubcat()">
										Save</button>
                                    </div>
                                </div></td>
											</tr>
